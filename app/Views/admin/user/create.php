                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class='form-group'>
                            ...
                            ?>
                            <span class="help-block"> Minimum 5 characters. Must be unique. </span>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class='form-group'>
                            <?php
                            // Roles
                            echo form_label('Roles', 'roles');
                            echo form_multiselect('roles[]', $roles, @$user_roles, ["id" => "roles", "size" => "2","class" => "form-control input-large"]);
                            // echo form_multiselect([
                            //     'name'          => 'roles[]',
                            //     'id'            => 'roles',
                            //     'value'         => set_value('roles', @$user_detail['username']),
                            //     'class'         => 'form-control',
                            // ]);
                            ?>
                        </div>
